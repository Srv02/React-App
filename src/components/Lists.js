...
const Lists = (props) => {
  ...
  const addItemHandler = (event) => {
    ...
    const doesItemExist = data?.findIndex(item => item.name?.toLowerCase() === newItem_Name.toLowerCase()) !== -1;
    if (doesItemExist) {
      const prevData = [...data];
      ...
      <div className="d-flex justify-content-center">
        <Card className={classes.card}>
          <CardBody>
              ...
              <form onSubmit={addItemHandler} id="form">
                <div className={classes.formContainer}>
                  <div className={classes.itemSection}>
                    <label htmlFor="newItem" className={classes.label}>Item Name*</label>
                    <input type="text" id="newItem" className={classes.itemInput} />
                  </div>
                  <div className={classes.quantitySection}>
                    <label htmlFor="newItem_Qty" className={classes.label}>Quantity*</label>
                    <div className="d-flex">
                      <input type="number" min={1} id="newItem_Qty" className={classes.quantityInput} />
            ...
            <div className={classes.getStarted}>To get started, add 1 or more items</div>
            <div>
                        ...
                        <div className={classes.quantityContainer}>
                          ...
                          <div className={classes.ctas}>
                            ...
                            <Decrement
                              ...
                              className={`${classes.ctaBtn} ${item.qty === 1 ? classes.btnDisabled : ''}`}
                            />
            ...
            {<button disabled={!data.length} onClick={removeAllItemHandler} className={`btn btn-light ${classes.clearAll}`}>Clear All</button>}
          </CardBody>
        </Card>
      </div>
    </div>
